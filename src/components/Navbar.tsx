  ...
  return (
    <nav className='flex items-center justify-between flex-wrap bg-blue-900 p-6'>
        <div className='flex items-center flex-shrink-0 text-white mr-6'>
            <Link to='/' className='font-semibold  text-5xl tracking-tight'>Game List App</Link>
        </div>
        <div className="block">
            <button 
                onClick={dropDown}
        ...
        { isVisible ? ( 
            <div className='w-full block flex-grow items-center'>
                <div className="text-sm lg:flex-grow">
                    <Button className="p-3 m-5 bg-blue-800 justify-center rounded">
                        <div>
                            <Link to='/' onClick={ clicked } className='flex place-items-center mt-4 lg:inline-block lg:mt-0 
                            text-blue-200 text-3xl hover:text-white mr-4'>
                                Home
                            </Link>
                        </div>
                    </Button>
                        ...
                        <Button className='p-3 m-5 bg-blue-800 justify-center rounded'>
                            <div>
                                <Link to="/" onClick={ () => { signInOnClick()}} className="flex place-items-center mt-4
                                 lg:inline-block lg:mt-0 text-blue-200 text-3xl hover:text-white">
                                    Login
                                </Link>
                            </div>
                        </Button>
